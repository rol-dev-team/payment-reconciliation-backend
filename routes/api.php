...
Route::middleware('auth:sanctum')->group(function () {
   ...
   Route::get('comparisons/{comparison}', [ComparisonController::class, 'show']);
   Route::prefix('reconciliation-summary')->group(function () {
Route::post('/', [ReconciliationSummaryController::class, 'getSummary']);
});
